...
function TheFinalResult() : void{
    const Ele = document.getElementById("ser") as HTMLInputElement;
    const btn = document.getElementById("btn") as HTMLButtonElement;
    const Show = document.getElementById("show") as HTMLTableElement;
    if(!Ele || !Show) return;
    ...
    btn.addEventListener("click" , ()=>{
        ...
        inpuNumber.forEach(i=>{
            if(!isNaN(parseInt(i))) ArrayOfnumber.push(parseInt(i));
        })
