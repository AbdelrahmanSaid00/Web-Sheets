"use strict";
const FormRegister = document.getElementById("form-valid");
const UsernameInput = document.getElementById("name");
const passwordInput = document.getElementById("pass");
const SelectInput = document.getElementById("semester");
const IsComp102 = document.getElementById("comp102");
const IsComp206 = document.getElementById("comp206");
const IsMath102 = document.getElementById("math102");
const button = document.getElementById("btn");
const Sign = document.getElementById("sign");
const UserError = document.getElementById("uError");
const PassError = document.getElementById("pError");
const SelectError = document.getElementById("sError");
const SwapPassword = document.getElementById("btnp");
function checkName() {
...
function coursesThatSelected() {
    let Courses = [];
    if (IsComp102.checked)
        Courses.push("Comp102");
    if (IsComp206.checked)
        Courses.push("Comp206");
    if (IsMath102.checked)
        Courses.push("math102");
...
`;
        ...
        if (newWindow) {
            ...
            let Text = newWindow.document.getElementById("h1");
